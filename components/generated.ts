...
export type GetBudgetCategoryQueryVariables = Exact<{
  passwordHash: Scalars['String'];
}>;


export type GetBudgetCategoryQuery = { __typename?: 'Query', budgetCategories: { __typename: 'BudgetCategoriesSuccess', budgetCategories: Array<{ __typename?: 'BudgetCategory', id: number, amount: number, category: { __typename?: 'Category', name: string } }> } | { __typename: 'FailurePayload', exceptionName?: string | null, errorMessage?: string | null } };
...
export type GetMonthBreakdownQuery = { __typename?: 'Query', monthBreakdown: { __typename: 'FailurePayload', exceptionName?: string | null, errorMessage?: string | null } | { __typename: 'MonthBreakdown', month: MonthType, year: number, totalSpent: number, byCategory: Array<{ __typename?: 'MonthBreakdownCategory', amountSpent: number, category?: { __typename?: 'Category', name: string, colourHex: string, id: number } | null }> } };
