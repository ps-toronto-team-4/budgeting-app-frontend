...
export type GetMerchantsQuery = { __typename?: 'Query', merchants: { __typename: 'MerchantsSuccess', merchants: Array<{ __typename?: 'Merchant', id: number, name: string, description?: string | null, defaultCategory?: { __typename?: 'Category', id: number, name: string, description?: string | null, colourHex: string } | null }> } | { __typename: 'FailurePayload', exceptionName?: string | null, errorMessage?: string | null }};
