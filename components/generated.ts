...
export type GetExpensesQuery = { __typename?: 'Query', expenses: { __typename?: 'ExpensesSuccess', expenses: Array<{ __typename?: 'Expense', amount: number, id: number, description?: string | null, category?: { __typename?: 'Category', colourHex: string, name: string } | null } | null> } | { __typename?: 'FailurePayload', errorMessage?: string | null, exceptionName?: string | null } };
